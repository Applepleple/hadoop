...
public class NodeInfo {
  ...
  protected long totalGpuAllocatedContainers;
  ...
  public NodeInfo(final Context context, final ResourceView resourceView) {
    ...
    this.totalGpuAllocatedContainers = resourceView
        .getGpuAllocatedForContainers();
  ...
  public long getTotalGpuAllocated() {
    return this.totalGpuAllocatedContainers;
  }
