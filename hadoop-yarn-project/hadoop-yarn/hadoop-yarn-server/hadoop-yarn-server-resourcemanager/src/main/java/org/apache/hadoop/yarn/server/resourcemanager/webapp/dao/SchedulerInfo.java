...
import org.apache.hadoop.yarn.server.resourcemanager.scheduler.fifo.GpuFifoScheduler;
...
public class SchedulerInfo {
  ...
  public SchedulerInfo(final ResourceManager rm) {
    ...
    } else if (rs instanceof GpuFifoScheduler) {
      this.schedulerName = "Gpu Fifo Scheduler";
    }
